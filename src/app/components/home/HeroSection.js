      ...
      <div className="relative z-10 flex min-w-0 flex-1 items-center">
        <div className="site-container pb-16 pt-28 sm:py-32 lg:py-40">
          <div className="max-w-[21rem] min-w-0 sm:max-w-xl">
            ...
            <p className="mb-2 font-display text-lg tracking-wide text-white/68 sm:text-2xl">{restaurantProfile?.name}</p>
            <h1 className="mb-5 font-display font-bold leading-[1.08] text-white sm:mb-6">
            ...
            <p className="mb-7 max-w-[20rem] text-[14px] leading-relaxed text-white/76 sm:mb-8 sm:max-w-md sm:text-base sm:text-white/65">
              Experience authentic Vietnamese recipes, fresh ingredients, and warm hospitality in Paphos.
            </p>

            <div className="mb-9 flex flex-col items-start gap-3 sm:mb-10 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            <div className="flex flex-wrap items-start gap-x-6 gap-y-3 text-[12px] text-white/55">
